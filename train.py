...
if args.data_set == 'waymo-od' and args.class_conditional:
    raise("We currently don't have labels for the small imagenet data set")
...
elif args.data_set == 'waymo-od':
    import data.waymo_od_data as waymo_od_data
    DataLoader = waymo_od_data.DataLoader
else:
